...
\caption{\label{tab:unnamed-chunk-10}Mean values and standard deviations (reported in pathenses) for the key variables from the organic grower survey for each time period}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:unnamed-chunk-22}Model comparison results}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:unnamed-chunk-23}Goodness of fit across models}
\centering
\begin{tabular}[t]{lrrr}
\toprule
...
\caption{\label{tab:unnamed-chunk-24}Full model results}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrr}
\toprule
...
\caption{\label{tab:unnamed-chunk-29}ERGM comparison for knowledge resource subsystem}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:unnamed-chunk-30}ERGM comparison for valuation resource subsystem}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{llllll}
\toprule
...
\caption{\label{tab:unnamed-chunk-33}Full model results}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrr}
\toprule
